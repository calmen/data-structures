...
public interface PQInterface {
	...
	public Processor max(); /*return without removing the object with the highest priority */
	
	public Processor getmax();/* remove and return the object with the highest priority*/
